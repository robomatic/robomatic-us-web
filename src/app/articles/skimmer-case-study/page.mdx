...
design patterns. Working with product management and utilizing user research,
...
<FigureImage src={imgSkimmerFigma} alt="Mockups done in Figma screenshot" caption="Figma Mockups" />
...
<FigureImage src={imgInvoicing} alt="Invoicing screenshot" caption="Invoice Management" />

<FigureImage src={imgInvoiceAdd} alt="Add invoice screenshot" caption="Add Invoice" />

<FigureImage src={imgInvoiceDetail} alt="Invoice detail screenshot" caption="Invoice Detail" />
...
<FigureImage src={imgDashboard} alt="Dashboard screenshot" caption="Dashboard Updates" />
