      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Rob Schuler, a product designer and software developer who helps companies turn
            complex ideas into clear, durable web applications. I work across strategy, interface
            design, and front-end engineering so products feel thoughtful from the first sketch to
